# Play Store listing — Al Islam wal Istibdad (الإسلام والاستبداد السياسي)
...
- **Package name**: `org.workshopdiy.alislamwalistibdad`
...
```
كتاب "الإسلام والاستبداد السياسي" تطبيق تفاعلي — للشيخ محمد الغزالي
```

### Full description (≤4000 chars)
```
⚖ الإسلام والاستبداد السياسي — تطبيق تفاعلي

تطبيق تفاعلي ثلاثي اللغة (عربي/إنجليزي/فرنسي) مستوحى من كتاب "الإسلام والاستبداد السياسي" للشيخ محمد الغزالي رحمه الله (1917–1996).
...
• كتاب "الإسلام والاستبداد السياسي" — الشيخ محمد الغزالي
...
### App name
```
Al Islam wal Istibdad — Islam & Political Tyranny
```

### Short description
```
"Islam & Political Tyranny" — interactive trilingual app by Sheikh al-Ghazali
```
...
Interactive trilingual app (Arabic / English / French) based on the book "Islam & Political Tyranny" by Sheikh Mohammed al-Ghazali (1917–1996).
...
• "Islam & Political Tyranny" — Sheikh Mohammed al-Ghazali
...
### App name
```
Al Islam wal Istibdad — Al Islam wal Istibdad
```

### Short description
```
« Islam & Political Tyranny » — application trilingue par Cheikh al-Ghazali
```
...
Application interactive trilingue (arabe / anglais / français) inspirée du livre « Islam & Political Tyranny » du Cheikh Mohammed al-Ghazali (1917–1996).
...
• « Islam & Political Tyranny » — Cheikh Mohammed al-Ghazali
...
```
Privacy Policy — Al Islam wal Istibdad
Last updated: 2026-04-26

The Al Islam wal Istibdad app does not collect, store, transmit, or share any personal
