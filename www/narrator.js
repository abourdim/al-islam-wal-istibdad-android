...
(function() {
  ...
  function setupMediaSession() {
    ...
    navigator.mediaSession.metadata = new MediaMetadata({
      title: l === 'ar' ? 'الإسلام والاستبداد السياسي' : l === 'fr' ? 'Islam et Tyrannie Politique' : 'Islam & Political Tyranny',
  ...
  function onSpeedChange(val) {
    ...
    localStorage.setItem('istibdad-narrator-speed', STATE.speed);
  }
  ...
  function onPitchChange(val) {
    ...
    localStorage.setItem('istibdad-narrator-pitch', STATE.pitch);
  }
  ...
  function onKaraokeToggle(checked) {
    ...
    localStorage.setItem('istibdad-narrator-karaoke', checked);
  }

  function onAutoScrollToggle(checked) {
    STATE.autoScroll = checked;
    localStorage.setItem('istibdad-narrator-autoscroll', checked);
  }

  function onDuoToggle(checked) {
    STATE.duoReading = checked;
    localStorage.setItem('istibdad-narrator-duo', checked);
  }
  ...
  function loadSettings() {
    STATE.speed = parseFloat(localStorage.getItem('istibdad-narrator-speed')) || 1;
    STATE.pitch = parseFloat(localStorage.getItem('istibdad-narrator-pitch')) || 1;
    STATE.karaokeEnabled = localStorage.getItem('istibdad-narrator-karaoke') !== 'false';
    STATE.autoScroll = localStorage.getItem('istibdad-narrator-autoscroll') !== 'false';
    STATE.duoReading = localStorage.getItem('istibdad-narrator-duo') === 'true';
  }
